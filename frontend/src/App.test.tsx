...
describe('App', () => {
  ...
  it('should reload the table with new data when a successful new submission is made', async () => {
    ...
    expect(await screen.findByRole('row', { name: /john doe solution.py success executed successfully 2024-06-01 10:00:00/i })).toBeInTheDocument()
    expect(await screen.findByRole('row', { name: /john doe solution_2.py failed an error occurred during execution 2024-06-02 11:00:00/i })).toBeInTheDocument()
    ...
    expect(await screen.findByRole('row', { name: /jane smith solution_3.py success executed successfully 2024-06-03 12:00:00/i })).toBeInTheDocument()
  })
    ...
    expect(await screen.findByRole('row', { name: /jane smith solution_3.py failed execution failed with error: SyntaxError: invalid syntax 2024-06-03 12:00:00/i })).toBeInTheDocument()
  })
})